    ...
    <div style={{ padding: "40px" }}>
      ...
      <div style={{ background: "var(--white)", border: "1px solid var(--border)", borderRadius: "8px", padding: "28px", marginBottom: "24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "16px" }}>
          ...
          <div>
            <label style={{ fontSize: "12px", fontWeight: "600", letterSpacing: "0.06em", textTransform: "uppercase", color: "var(--charcoal-light)", display: "block", marginBottom: "6px" }}>Min. Order (₹)</label>
      ...
      <div style={{ background: "rgba(201,149,108,0.06)", border: "1px solid rgba(201,149,108,0.2)", borderRadius: "6px", padding: "16px", fontSize: "13px", color: "var(--charcoal-light)" }}>
        <strong>Pre-seeded coupons:</strong> WELCOME10 (10% off, min ₹500) · FLAT200 (₹200 off, min ₹1000) · GURLY15 (15% off, min ₹1500)
      </div>
    </div>
  )
}
